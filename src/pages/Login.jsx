        ...
        <div className="rounded-[28px] border border-white/10 bg-white/4 backdrop-blur-2xl ring-1 ring-inset ring-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
          <div className="p-8 sm:p-10">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">Iniciar sesión</h1>
                <p className="mt-1 text-gray-300">Accede a tu cuenta para continuar</p>
              </div>
            </div>
            ...
            <form className="mt-8 space-y-5" onSubmit={doLogin}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-[#000A14]/80 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#33AACD]/60 focus:border-transparent"
                    type="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-14 py-3.5 rounded-2xl bg-[#000A14]/80 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#33AACD]/60 focus:border-transparent"
              ...
              <button
                type="submit"
                disabled={loading}
                className="relative w-full overflow-hidden rounded-2xl px-4 py-3.5 font-medium disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer transition focus:outline-none focus:ring-2 focus:ring-[#33AACD]/50 hover:brightness-110 active:brightness-95 hover:shadow-[0_8px_24px_rgba(51,170,205,0.35)]"
              >
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full relative flex items-center justify-center gap-3 rounded-2xl px-5 py-3 border border-white/10 bg-[#000A14]/80 hover:bg-[#0F1A2B]/70 cursor-pointer transition duration-200"
              >
