...
import { authRegisterLocal, authLoginGoogle } from "../lib/api";
          ...
          <div className="p-6 sm:p-8">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-300">Regístrate para comenzar</p>
              </div>
            </div>

            <form className="mt-8 space-y-5" onSubmit={doRegister}>
              ...
              >
                ...
                <span className="relative block text-center">{loading ? "Registrando…" : "Crear cuenta"}</span>
              </button>
            </form>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="font-medium text-white">Registrarse con Google</span>
              </button>
